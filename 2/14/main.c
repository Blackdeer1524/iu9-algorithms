...
int main() {
    char *checking = "vgbhnjmkvgbhnjmkvebcubnvgbhnv";
    char *prefix_container = "vgbhnjmkvebcubndshucgdve";
    assert(YES == is_prefix(checking, strlen(checking), prefix_container, strlen(prefix_container))); 

    checking = "123123";
    prefix_container = "123123";
    assert(YES == is_prefix(checking, strlen(checking), prefix_container, strlen(prefix_container))); 
